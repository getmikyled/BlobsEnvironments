...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UHoudiniInstancedActorComponent_Statics::NewProp_InstancedActorClass = { "InstancedActorClass", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHoudiniInstancedActorComponent, InstancedActorClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_InstancedActorClass_MetaData), NewProp_InstancedActorClass_MetaData) };
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_BlobsEnvironments_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInstancedActorComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniInstancedActorComponent, UHoudiniInstancedActorComponent::StaticClass, TEXT("UHoudiniInstancedActorComponent"), &Z_Registration_Info_UClass_UHoudiniInstancedActorComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniInstancedActorComponent), 309663362U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_BlobsEnvironments_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInstancedActorComponent_h_2926894728(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_BlobsEnvironments_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInstancedActorComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_BlobsEnvironments_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInstancedActorComponent_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
