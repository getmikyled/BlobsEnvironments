...
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Sometimes, specifically when editing level instances, the Unreal Editor will duplicate the HDA,\n// then duplicate it again, before we get a change to call UpdatePostDuplicate().\n// So bHasBeenDuplicated should not be cleared and is so not marked DuplicateTransient.\n" },
#endif
		{ "ModuleRelativePath", "Private/HoudiniAssetComponent.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Sometimes, specifically when editing level instances, the Unreal Editor will duplicate the HDA,\nthen duplicate it again, before we get a change to call UpdatePostDuplicate().\nSo bHasBeenDuplicated should not be cleared and is so not marked DuplicateTransient." },
#endif
	};
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniAssetComponent_Statics::NewProp_bHasBeenDuplicated = { "bHasBeenDuplicated", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UHoudiniAssetComponent), &Z_Construct_UClass_UHoudiniAssetComponent_Statics::NewProp_bHasBeenDuplicated_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bHasBeenDuplicated_MetaData), NewProp_bHasBeenDuplicated_MetaData) };
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UHoudiniAssetComponent_Statics::NewProp_ParameterPresetBuffer = { "ParameterPresetBuffer", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHoudiniAssetComponent, ParameterPresetBuffer), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ParameterPresetBuffer_MetaData), NewProp_ParameterPresetBuffer_MetaData) };
#if WITH_EDITORONLY_DATA
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_BlobsEnvironments_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniAssetComponent_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniAssetComponent, UHoudiniAssetComponent::StaticClass, TEXT("UHoudiniAssetComponent"), &Z_Registration_Info_UClass_UHoudiniAssetComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniAssetComponent), 2927634330U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_BlobsEnvironments_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniAssetComponent_h_3367473762(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_BlobsEnvironments_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniAssetComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_BlobsEnvironments_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniAssetComponent_h_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_BlobsEnvironments_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniAssetComponent_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_BlobsEnvironments_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniAssetComponent_h_Statics::EnumInfo));
// End Registration
