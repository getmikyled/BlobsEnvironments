...
HOUDINIENGINERUNTIME_API UScriptStruct* Z_Construct_UScriptStruct_FHoudiniAttributeDataLayer();
...
struct Z_Construct_UScriptStruct_FHoudiniBakedOutputObject_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_BakedPhysicsAsset_MetaData[] = {
#if !UE_BUILD_SHIPPING
		{ "Comment", "// For skeletal meshes, this is the physics that was baked for the skeletal mesh.\n" },
#endif
		{ "ModuleRelativePath", "Private/HoudiniOutput.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "For skeletal meshes, this is the physics that was baked for the skeletal mesh." },
#endif
	};
#endif // WITH_METADATA
	...
	static const UECodeGen_Private::FStrPropertyParams NewProp_BakedPhysicsAsset;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static void* NewStructOps()
	{
...
const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FHoudiniBakedOutputObject_Statics::NewProp_BakedPhysicsAsset = { "BakedPhysicsAsset", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FHoudiniBakedOutputObject, BakedPhysicsAsset), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BakedPhysicsAsset_MetaData), NewProp_BakedPhysicsAsset_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FHoudiniBakedOutputObject_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FHoudiniBakedOutputObject_Statics::NewProp_BakedPhysicsAsset,
};
...
// Begin ScriptStruct FHoudiniAttributeDataLayer
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_HoudiniAttributeDataLayer;
class UScriptStruct* FHoudiniAttributeDataLayer::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_HoudiniAttributeDataLayer.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_HoudiniAttributeDataLayer.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniAttributeDataLayer, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineRuntime(), TEXT("HoudiniAttributeDataLayer"));
	}
	return Z_Registration_Info_UScriptStruct_HoudiniAttributeDataLayer.OuterSingleton;
}
template<> HOUDINIENGINERUNTIME_API UScriptStruct* StaticStruct<FHoudiniAttributeDataLayer>()
{
	return FHoudiniAttributeDataLayer::StaticStruct();
}
struct Z_Construct_UScriptStruct_FHoudiniAttributeDataLayer_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Private/HoudiniOutput.h" },
	...
	static void* NewStructOps()
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FHoudiniAttributeDataLayer>();
	}
	static const UECodeGen_Private::FStructParams StructParams;
};
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHoudiniAttributeDataLayer_Statics::NewProp_DataLayers_Inner = { "DataLayers", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FHoudiniDataLayer, METADATA_PARAMS(0, nullptr) }; // 1880887850
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FHoudiniAttributeDataLayer_Statics::NewProp_DataLayers = { "DataLayers", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FHoudiniAttributeDataLayer, DataLayers), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DataLayers_MetaData), NewProp_DataLayers_MetaData) }; // 1880887850
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FHoudiniAttributeDataLayer_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FHoudiniAttributeDataLayer_Statics::NewProp_DataLayers_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FHoudiniAttributeDataLayer_Statics::NewProp_DataLayers,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHoudiniAttributeDataLayer_Statics::PropPointers) < 2048);
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FHoudiniAttributeDataLayer_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_HoudiniEngineRuntime,
	nullptr,
	&NewStructOps,
	"HoudiniAttributeDataLayer",
	Z_Construct_UScriptStruct_FHoudiniAttributeDataLayer_Statics::PropPointers,
	UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHoudiniAttributeDataLayer_Statics::PropPointers),
	sizeof(FHoudiniAttributeDataLayer),
	alignof(FHoudiniAttributeDataLayer),
	RF_Public|RF_Transient|RF_MarkAsNative,
	EStructFlags(0x00000001),
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHoudiniAttributeDataLayer_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FHoudiniAttributeDataLayer_Statics::Struct_MetaDataParams)
};
UScriptStruct* Z_Construct_UScriptStruct_FHoudiniAttributeDataLayer()
{
	if (!Z_Registration_Info_UScriptStruct_HoudiniAttributeDataLayer.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_HoudiniAttributeDataLayer.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniAttributeDataLayer_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_HoudiniAttributeDataLayer.InnerSingleton;
}
// End ScriptStruct FHoudiniAttributeDataLayer
...
struct Z_Construct_UScriptStruct_FHoudiniOutputObject_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_DataLayers_MetaData[] = {
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Data Layers which should be applied (during Baking only). There can be multiple data layers per actor.\n" },
#endif
		{ "ModuleRelativePath", "Private/HoudiniOutput.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Data Layers which should be applied (during Baking only). There can be multiple data layers per actor." },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_HLODLayers_MetaData[] = {
#if !UE_BUILD_SHIPPING
		{ "Comment", "// HLOD Layers which should be applied (during Baking only). Currently UE only supports one HLOD layer\n// per Actor, but we store this an array, since changing that would cause issues.\n" },
#endif
		{ "ModuleRelativePath", "Private/HoudiniOutput.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "HLOD Layers which should be applied (during Baking only). Currently UE only supports one HLOD layer\nper Actor, but we store this an array, since changing that would cause issues." },
#endif
	};
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UHoudiniOutput_Statics::NewProp_HoudiniGeoPartObjects_Inner = { "HoudiniGeoPartObjects", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FHoudiniGeoPartObject, METADATA_PARAMS(0, nullptr) }; // 1078408910
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UHoudiniOutput_Statics::NewProp_HoudiniGeoPartObjects = { "HoudiniGeoPartObjects", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHoudiniOutput, HoudiniGeoPartObjects), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_HoudiniGeoPartObjects_MetaData), NewProp_HoudiniGeoPartObjects_MetaData) }; // 1078408910
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UHoudiniOutput_Statics::NewProp_OutputObjects_ValueProp = { "OutputObjects", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FHoudiniOutputObject, METADATA_PARAMS(0, nullptr) }; // 2226145269
...
const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UHoudiniOutput_Statics::NewProp_OutputObjects = { "OutputObjects", nullptr, (EPropertyFlags)0x0020080000200000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHoudiniOutput, OutputObjects), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OutputObjects_MetaData), NewProp_OutputObjects_MetaData) }; // 3767398212 2226145269
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_BlobsEnvironments_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniOutput_h_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		...
		{ FHoudiniBakedOutputObject::StaticStruct, Z_Construct_UScriptStruct_FHoudiniBakedOutputObject_Statics::NewStructOps, TEXT("HoudiniBakedOutputObject"), &Z_Registration_Info_UScriptStruct_HoudiniBakedOutputObject, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniBakedOutputObject), 2668661935U) },
		{ FHoudiniBakedOutput::StaticStruct, Z_Construct_UScriptStruct_FHoudiniBakedOutput_Statics::NewStructOps, TEXT("HoudiniBakedOutput"), &Z_Registration_Info_UScriptStruct_HoudiniBakedOutput, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniBakedOutput), 1984658823U) },
		...
		{ FHoudiniAttributeDataLayer::StaticStruct, Z_Construct_UScriptStruct_FHoudiniAttributeDataLayer_Statics::NewStructOps, TEXT("HoudiniAttributeDataLayer"), &Z_Registration_Info_UScriptStruct_HoudiniAttributeDataLayer, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniAttributeDataLayer), 2487902208U) },
		...
		{ FHoudiniOutputObject::StaticStruct, Z_Construct_UScriptStruct_FHoudiniOutputObject_Statics::NewStructOps, TEXT("HoudiniOutputObject"), &Z_Registration_Info_UScriptStruct_HoudiniOutputObject, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniOutputObject), 2226145269U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		...
		{ Z_Construct_UClass_UHoudiniOutput, UHoudiniOutput::StaticClass, TEXT("UHoudiniOutput"), &Z_Registration_Info_UClass_UHoudiniOutput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniOutput), 1986810896U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_BlobsEnvironments_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniOutput_h_3086639650(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_BlobsEnvironments_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniOutput_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_BlobsEnvironments_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniOutput_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_BlobsEnvironments_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniOutput_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_BlobsEnvironments_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniOutput_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_BlobsEnvironments_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniOutput_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_BlobsEnvironments_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniOutput_h_Statics::EnumInfo));
// End Registration
