...
#define UE_MODULE_NAME "HoudiniEngineEditor"
...
#define HOUDINIENGINEEDITOR_API DLLEXPORT
#define HOUDINIENGINE_API DLLIMPORT
#define HOUDINIENGINERUNTIME_API DLLIMPORT
