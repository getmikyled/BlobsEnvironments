...
set_target_properties(torch_cuda PROPERTIES
  INTERFACE_COMPILE_OPTIONS "\$<\$<COMPILE_LANGUAGE:CXX>:;\$<\$<OR:\$<CONFIG:Debug>,\$<CONFIG:RelWithDebInfo>>:/Z7>;/EHsc;/bigobj>"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "-INCLUDE:?warp_size@cuda@at@@YAHXZ;torch::cudart;c10_cuda;torch::nvtoolsext;torch_cpu_library;caffe2::cufft;caffe2::curand;caffe2::cublas"
)
